...
<body>
	<header class="w3-light-green w3-container">
		<h1 class="w3-text-white">
			Course Registration Online System <span
				class="w3-tag w3-yellow w3-small">(CRO)</span>
		</h1>
	</header>
	...
	<section class="w3-margin">
				...
				<form method="get" action="users/login" class="w3-padding">
					<p>
						<label>Email</label> <input name="email"
							class="w3-input w3-border" type="text" placeholder="email" />
					</p>
					<p>
		...
		<div class="w3-threequarter">
			<h3 class="w3-center">
				<b>Student Account Register</b>
			</h3>
			<hr />
			<form method="post" action="users/register"
				class="w3-clear w3-padding">
				<div class="w3-half w3-padding">
					...
					<p>
						<label>Email</label> <input class="w3-input w3-border"
							type="email" placeholder="email" name="email" />
					</p>
					<p>
						<label>Mobile</label> <input class="w3-input w3-border"
							type="text" placeholder="phone" name="mobile" />
					</p>

				</div>
				<div class="w3-half w3-padding">
					<p>
						<label>Student ID</label> <input class="w3-input w3-border"
							type="number" placeholder="student id" name="studentId" />
					</p>
					<p>
	...
	<footer class="w3-light-green w3-container w3-padding-32 w3-bottom">
		<p class="w3-text-white">&copy; Dekastan State University (Civitas
			Universitas Dekastan)</p>
	</footer>
</body>
</html>
